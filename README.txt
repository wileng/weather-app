...
It utilizes the OpenWeatherMap (OWM) API to get weather information, and the GSON library from Google to deserialize JSON strings/files.
NOTE: the files for the GSON library are not included in this repository. You can find them at this link: https://github.com/google/gson
